...
assert(!(await text()).includes("Today's Revenue"), 'Dashboard should not show daily period labels')
assert(!(await text()).includes('This Week'), 'Dashboard should not show weekly period controls')
